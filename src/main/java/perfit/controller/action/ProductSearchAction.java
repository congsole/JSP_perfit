...
public class ProductSearchAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String price_R = request.getParameter("price_R"); // 아이디 받아와서 가격이랑 같이 검색 ... jsp에서는 productSize다오에서 받아온 아이디랑 비교해서 있는 것만 뿌리기.
		...
		List<String> idList = ProductSizeDAO.selectIdsBySearch
				(type_chk, category_chk, total_length_L, total_length_R
				, shoulder_L, shoulder_R, bust_L, bust_R, waist_L, waist_R
				, sleeve_L, sleeve_R);
