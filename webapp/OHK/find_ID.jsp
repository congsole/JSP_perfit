...
<body class="home">
    ...
    <div id="login_container">
        <div class="title_wrap"><h1>아이디 찾기</h1></div>
        <form id="login_form" action="ProductServlet">
        <input type="hidden" name="command" value="member_id_find">
            <table>
                <tr>
                ...
                <tr>
                	<div class="fr">
                    	<td class="co">
                        	<input type="submit" id="login_btn" value="아이디 찾기" onclick="id_search()">
                        	<p><a href="ProductServlet?command=member_pwd_find_form">&nbsp;&nbsp;비밀번호 찾기&nbsp;&nbsp;</a>
