...
<body class="home">
	...
	<div class="main">
		...
		<form action="ProductServlet">
			<input type="hidden" name="command" value="picture_upload">
			...
			<h1> 상세 사진 </h1>
			상세샷 1 : <input type="file" name="detail1"> <br>
			상세샷 2 : <input type="file" name="detail2"> <br>
			상세샷 3 : <input type="file" name="detail3"> <br>
			상세샷 4 : <input type="file" name="detail4"> <br>
			상세샷 5 : <input type="file" name="detail5"> <br>
			상세샷 6 : <input type="file" name="detail6"> <br>
			상세샷 7 : <input type="file" name="detail7"> <br>
			상세샷 8 : <input type="file" name="detail8"> <br>
			상세샷 9 : <input type="file" name="detail9"> <br>
