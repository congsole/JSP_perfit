		...
		<h3>
			<ul>
				<c:if test="${type == 'OUTER'}"> 
					<li id="1st_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;코트&nbsp;&nbsp;</a> |</li>
					<li id="2nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;점퍼&nbsp;&nbsp;</a> |</li>
					<li id="3nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;가디건&nbsp;&nbsp;</a> |</li>
					<li id="4rd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;패딩&nbsp;&nbsp;</a> |</li>
				</c:if>
				<c:if test="${type == 'TOP'}">
					<li id="1st_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;티셔츠&nbsp;&nbsp;</a> |</li>
					<li id="2nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;후드&nbsp;&nbsp;</a> |</li>
					<li id="3nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;맨투맨&nbsp;&nbsp;</a> |</li>
					<li id="4rd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;니트&nbsp;&nbsp;</a> |</li>
					<li id="5th_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;민소매&nbsp;&nbsp;</a></li>
				</c:if>
				<c:if test="${type == 'PANTS'}">
					<li id="1st_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;데님&nbsp;&nbsp;</a> |</li>
					<li id="2nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;슬랙스&nbsp;&nbsp;</a> |</li>
					<li id="3nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;리넨&nbsp;&nbsp;</a> |</li>
					<li id="4rd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;숏&nbsp;&nbsp;</a> |</li>
				</c:if>
				<c:if test="${type == 'SKIRT'}">
					<li id="1st_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;미니&nbsp;&nbsp;</a> |</li>
					<li id="2nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;미디움&nbsp;&nbsp;</a> |</li>
					<li id="3nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;롱&nbsp;&nbsp;</a> |</li>
				</c:if>
				<c:if test="${type == 'ONEPIECE'}">
					<li id="1st_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;미니&nbsp;&nbsp;</a> |</li>
					<li id="2nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;미디움&nbsp;&nbsp;</a> |</li>
					<li id="3nd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;롱&nbsp;&nbsp;</a> |</li>
					<li id="4rd_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;점프수트&nbsp;&nbsp;</a> |</li>
					<li id="5th_category"><a style="color: rgb(34,34,34)" href="#">&nbsp;&nbsp;투피스&nbsp;&nbsp;</a></li>			
				</c:if>
